...
#
# Install the feed with the printer's own opkg, seed the user's
...
#
# A gate here would ask whether opkg had installed the package it was just
...
# anvil-s6-rc ships, straight after opkg installs the feed. Compiling with the
