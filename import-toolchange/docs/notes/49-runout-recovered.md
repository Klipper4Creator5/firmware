...
`klippy-extras/ff_toolchange.py` (`[ff_toolchange] runout_switch_prefix: fd_ex`,
...
`config/ff-runout.cfg` (include after `printer.base.cfg`; Klipper merges repeated sections,
