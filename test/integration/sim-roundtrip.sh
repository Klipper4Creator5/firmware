...
#
#   ./test/integration/sim-roundtrip.sh <mod.tgz> <stock.tgz>
set -uo pipefail
...
BASE_PKG="$B" exec "$ROOT/test/integration/printer-exec.sh" \
    "$ROOT/test/integration/printer/case-recovery.sh" "mod.tgz=$A" "stock.tgz=$B"
