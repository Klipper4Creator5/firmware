...
These run against pkgs/klipper/payload/klipper/klippy/extras/ff_legacy.py with the klippy
objects
...
def _load_ff_legacy():
    path = os.path.join(ROOT, "pkgs", "klipper", "payload", "klipper", "klippy", "extras", "ff_legacy.py")
